...
<? include "../../block/header.php"; ?>
	...
	<div class="item">
		<div class="item_c">
				...
				<div class="bl_c">
					...
					<div class="itemc_dn">
						...
						<div class="itemcd_i">
							...
							<div class="itemcd_in">
								<div>Практикум</div>
								<p>10-15 минуттық қысқа әрі жеңіл сабақтар</p>
							</div>
						</div>
						<div class="itemcd_i">
			...
			<!--  -->
			<? $word = db::query("select * from cours_word where cours_id = '$cours_id' and type = 'tuu' and number BETWEEN 1 and 7"); ?>
			...
			<? $word = db::query("select * from cours_word where cours_id = '$cours_id' and type = 'tuu' and number BETWEEN 8 and 15"); ?>
			<? if (mysqli_num_rows($word)): ?>
				<div class="cr2">
					<div class="bl_c">
						<div class="head_c head_c1">
						...
						<div class="swiper blo7_Swiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-2.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-3.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-4.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-5.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-6.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-7.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-8.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-9.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-10.jpeg"></div>
								</div>
								<div class="swiper-slide">
									<div class="lz_o7 lz_o8" data-src="/assets/uploads/review/4k-11.jpeg"></div>
								</div>
