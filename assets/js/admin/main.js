...
$(document).ready(function() {
   ...
   // add user
	...
	$('.user_search_in').on('input', function () { 
		$.ajax({
			url: "/admin/users/search.php?user_search",
			type: "POST",
			dataType: "html",
	...
	$('.cours_user_search_in').on('input', function () {
		...
		$.ajax({
			url: "/admin/course/users/search.php?user_search",
			type: "POST",
			dataType: "html",
			data: ({ 
				search: inp.val(),
	...
	$('.sub_user_search_in').on('input', function () {
		...
		$.ajax({
			url: "/admin/club/users/search.php?user_search",
			type: "POST",
			dataType: "html",
			data: ({ search: inp.val() }),
			success: function(data){
   ...
   $('html').on('click', '.user_del', function(){
      ...
      $.ajax({
         url: "/admin/course/users/get.php?user_del",
         type: "POST",
         dataType: "html",
         data: ({ id:id }),
         success: function(data){
   ...
   $('.add_user_send').on('click', function(){
      ...
      if (phone.attr('data-sel') == 1) {
         $.ajax({
            url: "/admin/course/users/get.php?add_user",
            type: "POST",
            dataType: "html",
            data: ({
               phone : phone.attr('data-val'),
         ...
         $.ajax({
            url: "/admin/course/users/get.php?add_umail",
            type: "POST",
            dataType: "html",
            data: ({
