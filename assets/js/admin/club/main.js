...
$(document).ready(function() {
	...
	$('.add_user_sub_send').on('click', function(){
		...
		if (phone.attr('data-sel') == 1) {
			$.ajax({
				url: "/admin/club/users/get.php?add_user",
				type: "POST",
				dataType: "html",
			...
			$.ajax({
				url: "/admin/club/users/get.php?add_umail",
				type: "POST",
				dataType: "html",
	...
	$('.html').on('.sub_sms_send', 'click', function(){
		...
		$.ajax({
			url: "/admin/club/users/get.php?sms_send",
			type: "POST",
			dataType: "html",
			data: ({ id:id }),
			success: function(data){
	...
	$('html').on('click', '.sub_user_del', function(){
		...
		var btn = $(this)
		$.ajax({
			url: "/admin/club/users/get.php?user_del",
			type: "POST",
			dataType: "html",
			data: ({ id:id }),
			success: function(data){
	...
	$('html').on('click', '.sub_buy_off', function(){
		...
		$.ajax({
			url: "/admin/club/users/get.php?buy_off",
			type: "POST",
			dataType: "html",
			data: ({ id:id, off:off }),
			success: function(data){
   ...
   $('.sms_send_all').on('click', function(){
   	$.ajax({
   		url: "/admin/club/users/get.php?sms_send_all",
   		type: "POST",
   		dataType: "html",
   		data: ({}),
   		success: function(data){
