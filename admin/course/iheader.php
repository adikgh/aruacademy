...
<div class="uitemc_u">
   <div class="uitemc_um">
      <a class="uitemc_umi <?=($pod_menu_name=='main'?'uitemc_umi_act':'')?>" href="/admin/course/?id=<?=$cours_id?>">
         <div><i class="fal fa-info-circle"></i></div>
         <span>Жалпы</span>
      </a>

      <a class="uitemc_umi <?=($pod_menu_name=='users'?'uitemc_umi_act':'')?>" href="/admin/course/users/?id=<?=$cours_id?>">
         <div><i class="fal fa-users"></i></div>
         <span>Оқушылар</span>
      </a>

      <? if ($cours_d['ques']): ?>
         <a class="uitemc_umi <?=($pod_menu_name=='ques'?'uitemc_umi_act':'')?>" href="/admin/course/ques.php?id=<?=$cours_id?>">
      ...
      <? if (!$cours_d['setting']): ?>
         ...
         <a class="uitemc_umi <?=($pod_menu_name=='setting'?'uitemc_umi_act':'')?>" href="/admin/cours/item/edit.php?id=<?=$cours_id?>">
            <div><i class="fal fa-archive"></i></div>
