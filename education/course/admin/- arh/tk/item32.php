<?php include "../../../config/core.php";
   ...
   // site setting
	...
	$site_set = [
		...
		'footer' => 'false',
      'ublock' => 'true',
      'utop_nm' => '4 жасқа дейінгі баланың даму деңгейін анықтайтын тест ('.$lesson['number'].'. '.$lesson['name_'.$lang].')',
...
<?php include "../../../block/header.php"; ?>
   ...
   <div class="ulesson">
      ...
      <!-- <div class="ut_l">
         ...
         <span>4 жасқа дейінгі баланың даму деңгейін анықтайтын тест</span>
      </div> -->
