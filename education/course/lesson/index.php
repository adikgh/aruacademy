         ...
         <div class="ulesson_c">
            ...
            <div class="ulesson_btn">
               <div class="ulesson_btn_c">
                  ...
                  <div class="">
                     <? if ($lesson_prev_id): ?>
                        <a class="ulesson_btn_i btn_prev" href="/education/course/lesson/?id=<?=$lesson_prev_id?>" >
                  ...
                  <div class="">
                     <? if ($lesson_next_id): ?>
                        <a class="ulesson_btn_i btn_next" href="/education/course/lesson/?id=<?=$lesson_next_id?>" >
