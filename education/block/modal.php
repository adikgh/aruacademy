      ...
      <div class="pop_bl_cl">
         <div class="form_c">
            ...
            <div class="form_im">
               ...
               <input type="tel" class="form_txt fr_age user_age" placeholder="18" data-lenght="2" value="<?=$user['age']?>" />
            ...
            <!-- <div class="form_im">
               ...
               <input type="tel" class="form_txt fr_code user_code" placeholder="0000" data-lenght="4" value="<?=$user['code']?>" />
