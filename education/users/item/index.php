<?php include "../../../config/core.php";
	...
	// 
	$user_f = db::query("select * from user where `right` is null order by ins_dt desc limit 50");
...
<?php include "../../../block/header.php"; ?>
	...
	<div class="">
		...
		<!-- <div class="ucours_t">
			<div class="ucours_tm swiper swiper_catalog2">
				<div class="swiper-wrapper">
					<a class="swiper-slide ucours_tm_i ucours_tm_act" href="/u/admin/users">Барлығы (<?=mysqli_num_rows($user_f)?>)</a>
				</div>
		...
		<div class="uc_u">
			...
			<div class="uc_uc">
				<?php if (mysqli_num_rows($user_f) != 0): ?>
					<?php while ($user_d = mysqli_fetch_assoc($user_f)): ?>
						...
						<div class="uc_ui">
							<div class="uc_uil">
								...
								<div class="uc_ui_number"><?=fun::buy_rows($user_d['id'])?></div>
							</div>
							<div class="uc_uib">
